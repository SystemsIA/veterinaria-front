            ...
            >
              ...
              <Grid item xs={6}>
                <Paper className={classes.paper}>
                  ...
                  consectetur adipisicing elit. Itaque ea nulla quisquam sit in
                  deleniti non dolor quidem accusantium, incidunt assumenda
                  odit, eius quae illo a labore ullam consequatur! Maxime
                  consequatur distinctio animi sint placeat! Praesentium
                  consequuntur eum cupiditate nesciunt nemo unde exercitationem!
                </Paper>
              </Grid>
            </Grid>
          </Grid>
          ...
          <Grid container spacing={1}>
            <Grid container item sm={6} spacing={1} direction="column">
              <Grid item sm={3}>
                <Paper className={classes.paper}>
                  Lorem ipsum dolor sit amet consectetur adipisicing elit.
                  Cupiditate deleniti sed suscipit cum doloremque labore beatae
                  similique quaerat quos repellendus! Autem, laborum et! Cumque
                  ratione officia sapiente unde cupiditate voluptas rerum
                  tempore, sint tempora, blanditiis quisquam eaque. Quibusdam
                  ipsum dolorem quia quae magnam. Lorem ipsum dolor sit amet
                  consectetur adipisicing elit. Itaque ea nulla quisquam sit in
                  deleniti non dolor quidem accusantium, incidunt assumenda
                  odit, eius quae illo a labore ullam consequatur! Maxime
                  consequatur distinctio animi sint placeat! Praesentium
